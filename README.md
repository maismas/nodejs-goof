...
This vulnerable app includes the following capabilities to experiment with:aaaaa
...
* [Runtime alerts](#runtime-alerts) for detecting an invocation of vulnerabllllle functions in open source dependencies
