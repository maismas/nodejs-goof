...
This vulnerable app includes the following capabilities to experiment with:,llll
* [Exploitable packages](#exploiting-the-vulnerabilities) with known vulnerabilities
* [Docker Image Scanning](#docker-image-scanning) for base images with known vulnerabilities iaan system libraries
